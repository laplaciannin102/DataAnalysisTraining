...
class AnnnPreprocessing():
    ...
    def exe_pp(self):
        ...
        # 種々のカラムのdict
        # ignore, number, class, category, dummy, dtime
...
def general_preprocessing(df, ignore_cols=[], cls_cols=[], cate_cols=[], num_cols=[], scaling=False):
    """
    一般的な前処理全般を行う関数。
